...
//		receiver.SendMail("abhishek.bizlem@gmail.com", "adttech26@gmail.com", "", "hello", "hi how r u");
    ...
    public static String sendEmail(final String recipients, final String from,
            ...
            final String smtpserver, final String username, final String password,final String appPath) throws UnsupportedEncodingException {
...
//            message.setFrom(from);
            message.setFrom(new InternetAddress(username,fromName));  // extra line for leadautoconvert to dispaly name.
            ...
            if (attachments!=null){
            	...
            	System.out.println("Not Found Any Attachments");
            }
