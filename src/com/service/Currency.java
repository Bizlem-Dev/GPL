...
public class Currency {
    ...
    public static String convertToIndianCurrency(String num) {
        ...
        String curValue = "";
        if(decimal > 0){
         curValue = "Rupees " + Rupees + paise + "Paise Only";
        }else if(decimal == 0){
        	 curValue = "Rupees " + Rupees + " Only";	
        }
        String curValueWithProperSpacing = curValue.replaceAll("\\s+", " ");
        return curValueWithProperSpacing;
    }
    ...
    public static void main(String[] args) {
        System.out.println("result :: "+Currency.convertToWord("0100")); 
        System.out.println(Currency.format(7049957));
    }
    
    /******** Digit to  Indian Number  ********/
